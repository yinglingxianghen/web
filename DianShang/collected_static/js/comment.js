jQuery.fn.rater = function (options) {
    var settings = {
        ...
        title_format: null,
        info_format: null,
        image: '/static/img/stars.jpg',
        imageAll: '/static/img/stars-all.gif',
        defaultTips: true,
        clickTips: true,
        width: 24,
        height: 24
    ...
    var options = {
        ...
        title_format: function (value) {
            ...
            switch (value) {
                case 1:
                    title = '很不满意' +
                        ' <input type="hidden" id="star_count" name="star_count" value="1">';
                    break;
                case 2:
                    title = '不满意'+
                        ' <input type="hidden" id="star_count" name="star_count" value="2">';
                    break;
                case 3:
                    title = '一般' +
                        ' <input type="hidden" id="star_count" name="star_count" value="3">';
                    break;
                case 4:
                    title = '满意'+
                        ' <input type="hidden" id="star_count" name="star_count" value="4">';
                    break;
                case 5:
                    title = '非常满意' +
                        ' <input type="hidden" id="star_count" name="star_count" value="5">';
                    break;
                default:
                    title = value;
                    break;
