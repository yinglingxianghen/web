...
class WxPayConf_pub(object):
    ...
    APPID = "wxc7da30fa3139d25d"
    #JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = "c213ec86f46a4d0f2dc86067279a02df"
    #受理商ID，身份标识
    MCHID = "1459558402"
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "weixincareeruwxKEYis20170320univ"
    ACCESS_TOKEN=""

    #购买课程成功模板id
    BUY_COURSES_SUCCESS_TEMPLATE_ID=""
    BUY_COURSES_SUCCESS_HREF_URL="http://wx.careeru.cn"
    #=======【异步通知url设置】===================================
    #异步通知url，商户根据实际开发过程设定
    #NOTIFY_URL = "http://www.careeru.cn/shoppingcart/nativenotify"
    NOTIFY_URL = "http://www.careeru.cn/shoppingcart/nativenotify/"
    #=======【JSAPI路径设置】===================================
    #获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
    JS_API_CALL_URL = "http://www.careeru.cn/shoppingcart/wxpay/?showwxpaytitle=1"
    ...
    #上面为php版本专用
    #下面为其他语言使用
    SSLCERT_PATH = "//cacert/apiclient_cert.p12"
