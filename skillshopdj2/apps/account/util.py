...
def get_pyletter(str_input):
    if isinstance(str_input, six.text_type):
...
font = ImageFont.truetype(settings.BASE_DIR+'/static/fonts/fzstjw.ttf', 30)
filename = settings.BASE_DIR+'/static/images/checkbg.png'
size = (320,69)
point_chance=6
...
def create_validate_code(size=(120, 30),
    ...
    def create_strs():
        ...
        font = ImageFont.truetype(settings.BASE_DIR + '/static/fonts/Monaco.ttf', 20)
